...
const LOGOS = [
  { name: "NSE", full: "National Stock Exchange", color: "#E01F2E" },
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        backgroundImage: "radial-gradient(rgba(224,31,46,0.12) 1px, transparent 1px)",
      ...
      <div className="future-glow" style={{
        ...
        background: "radial-gradient(circle, rgba(224,31,46,0.14) 0%, transparent 60%)",
        filter: "blur(80px)", zIndex: 0,
      }} />
      <div style={{
        position: "absolute", bottom: "-80px", left: "-80px",
        width: "500px", height: "500px",
        background: "radial-gradient(circle, rgba(224,31,46,0.08) 0%, transparent 60%)",
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div className="future-eyebrow" style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "1.5rem" }}>
          <Sparkle size={16} color="#E01F2E" weight="fill" />
          <span style={{
        ...
        <h2 className="future-h2" style={{
          ...
          The future of{" "}
          <span style={{ color: "#E01F2E" }}>Rapid RatioG</span>
        </h2>
        ...
        >
          {items.map((item, i) => (
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = "rgba(224,31,46,0.45)";
                e.currentTarget.style.background = "rgba(224,31,46,0.05)";
                e.currentTarget.style.transform = "translateY(-6px)";
                e.currentTarget.style.boxShadow = "0 16px 48px rgba(224,31,46,0.1)";
              }}
              onMouseLeave={(e) => {
            ...
            >
              <div style={{
                ...
                background: "rgba(224,31,46,0.12)",
                borderRadius: "14px",
                display: "flex", alignItems: "center", justifyContent: "center",
                marginBottom: "1.4rem",
                border: "1px solid rgba(224,31,46,0.2)",
              }}>
                {item.icon}
              </div>
              <h3 style={{
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <a
            ...
            style={{
              ...
              color: "white", borderRadius: "14px", padding: "15px 32px",
              fontFamily: "Satoshi, sans-serif", fontWeight: 700, fontSize: "15px",
              textDecoration: "none",
              transition: "all 0.3s cubic-bezier(0.34,1.56,0.64,1)",
              boxShadow: "0 6px 24px rgba(224,31,46,0.35)",
              opacity: 0, // GSAP animates
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = "translateY(-3px) scale(1.03)";
              e.currentTarget.style.boxShadow = "0 12px 40px rgba(224,31,46,0.5)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = "translateY(0) scale(1)";
              e.currentTarget.style.boxShadow = "0 6px 24px rgba(224,31,46,0.35)";
            }}
          >
            Explore prices now
